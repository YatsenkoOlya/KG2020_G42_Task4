...
public class Vector3 {
    ...
    public Vector3(Vector3 v) {
        values = new float[]{v.getX(), v.getY(), v.getZ()};
    }

    public void movePlus(Vector3 v) {
        values[0] += v.getX();
        values[1] += v.getY();
        values[2] += v.getZ();
    }

    public void moveMinus(Vector3 v) {
        values[0] -= v.getX();
        values[1] -= v.getY();
        values[2] -= v.getZ();
    }
    ...
    public float getDistanceToAnotherPoint(Vector3 point) {
